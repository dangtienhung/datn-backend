...
manager.addDocument('vi','Làm thế nào để biết được loại trà sữa và topping nào là phổ biến và được ưa chuộng nhất?','URHSH18K');
manager.addDocument('vi','Bạn có thể cho tôi biết thêm về quy trình chọn trà sữa và topping ở cửa hàng của bạn không?','URHSH18K');
manager.addDocument('vi','Có những nguyên tắc nào cần tuân thủ khi chọn trà sữa và topping?','URHSH18K');
manager.addDocument('vi','Bạn có gợi ý nào để chọn trà sữa và topping phù hợp với sở thích của mình không?','URHSH18K');

//Ans
manager.addAnswer('vi','URHSH18K','Trên trang web, bạn thường sẽ thấy menu hiển thị các loại trà sữa và topping. <br>Bạn có thể chọn các tùy chọn yêu thích của mình và thêm chúng vào giỏ hàng.');
manager.addAnswer('vi','URHSH18K','Trên trang web, bạn sẽ thấy danh sách các loại trà sữa và topping để bạn lựa chọn. Bạn có thể chọn những loại mà bạn thích và thêm vào giỏ hàng.');
manager.addAnswer('vi','URHSH18K','Khi bạn truy cập vào trang web, bạn sẽ thấy danh sách các loại trà sữa và topping. Bạn chỉ cần chọn những loại mà bạn muốn và thêm vào giỏ hàng.');
manager.addAnswer('vi','URHSH18K','Trên trang web, có menu hiển thị các loại trà sữa và topping. Bạn có thể lựa chọn những loại mà bạn thích và thêm vào giỏ hàng của mình.');
manager.addAnswer('vi','URHSH18K','Nếu bạn vào trang web, bạn sẽ thấy danh sách các loại trà sữa và topping. Bạn chỉ cần chọn những loại mà bạn muốn và thêm vào giỏ hàng để đặt hàng.');
manager.addAnswer('vi','URHSH18K','Khi bạn truy cập vào trang web, bạn sẽ thấy danh sách các loại trà sữa và topping. Bạn có thể lựa chọn những loại mà bạn thích và thêm vào giỏ hàng để mua hàng.');
...
manager.addDocument('vi','Có những cách nào để điều chỉnh kích cỡ và đường của trà sữa không?','URHSH19G');
manager.addDocument('vi','Làm thế nào để tùy chỉnh kích cỡ và đường của trà sữa?','URHSH19G');
manager.addDocument('vi','Có những phương pháp nào để điều chỉnh kích cỡ và đường của trà sữa?','URHSH19G');
manager.addDocument('vi','Bạn có thể giúp tôi biết cách thay đổi kích cỡ và đường của trà sữa không?','URHSH19G');
//Ans
manager.addAnswer('vi','URHSH19G','Thông thường, bạn có thể chọn kích cỡ và lượng đường trong quá trình đặt hàng trực tuyến. Sẽ có tùy chọn để tùy chỉnh đặc điểm này.');
manager.addAnswer('vi','URHSH19G','Thông thường, khi bạn đặt hàng trực tuyến, bạn có thể lựa chọn kích cỡ và lượng đường theo ý muốn của mình.');
manager.addAnswer('vi','URHSH19G','Khi mua trà sữa trực tuyến, bạn sẽ có thể tuỳ chỉnh kích cỡ và đường cho đúng với sở thích của mình.');
manager.addAnswer('vi','URHSH19G','Trong quá trình đặt hàng trực tuyến, bạn có thể tùy chỉnh kích cỡ và đường của trà sữa theo mong muốn của mình.');
manager.addAnswer('vi','URHSH19G','Khi đặt mua trà sữa trực tuyến, bạn sẽ có tùy chọn để điều chỉnh kích cỡ và đường theo ý muốn cá nhân.');
manager.addAnswer('vi','URHSH19G','Thông thường, khi mua trà sữa qua mạng, bạn có thể thay đổi kích cỡ và đường để phù hợp với sở thích của mình.');
...
manager.addDocument('vi','Có cách nào để xem lại giỏ hàng trước khi tiến hành thanh toán không?','URHSH20G');
manager.addDocument('vi','Làm sao để xem các sản phẩm đã chọn trong giỏ hàng trước khi thanh toán?','URHSH20G');
manager.addDocument('vi','Có phương pháp nào để kiểm tra lại các mặt hàng trong giỏ hàng trước khi hoàn tất thanh toán không?','URHSH20G');
//Ans
manager.addAnswer('vi','URHSH20G','Trên trang web, Khi bạn đã chọn được trà sữa yêu thích của mình và nhấn nút "Thêm  giỏ hàng",  ngay lập tức các sản phẩm bạn chọn sẽ xuất hiện ở giỏ hàng phía bên phải màn hình .Bạn có thể nhấp vào đó để xem các sản phẩm đã chọn và điều chỉnh chúng trước khi thanh toán.');
manager.addAnswer('vi','URHSH20G','Sau khi bạn thêm trà sữa yêu thích vào giỏ hàng, các sản phẩm sẽ tự động hiển thị trong giỏ hàng phía bên phải màn hình. Bạn có thể nhấp vào giỏ hàng để xem và chỉnh sửa các sản phẩm trước khi tiến hành thanh toán.');
manager.addAnswer('vi','URHSH20G','Khi bạn nhấn nút "Thêm giỏ hàng" sau khi chọn trà sữa yêu thích, các sản phẩm sẽ ngay lập tức xuất hiện trong giỏ hàng ở phía bên phải màn hình. Bạn có thể xem và điều chỉnh các sản phẩm trong giỏ hàng trước khi tiến hành thanh toán.');
manager.addAnswer('vi','URHSH20G','Ngay sau khi bạn chọn trà sữa yêu thích và nhấn nút "Thêm giỏ hàng", các sản phẩm sẽ hiển thị trong giỏ hàng phía bên phải màn hình. Bạn có thể nhấp vào giỏ hàng để kiểm tra và điều chỉnh các sản phẩm trước khi thanh toán.');
manager.addAnswer('vi','URHSH20G','Khi bạn thêm trà sữa yêu thích vào giỏ hàng bằng cách nhấn nút "Thêm giỏ hàng", các sản phẩm sẽ tức thì xuất hiện trong giỏ hàng phía bên phải màn hình. Bạn có thể xem và chỉnh sửa các sản phẩm trong giỏ hàng trước khi tiến hành thanh toán.');
manager.addAnswer('vi','URHSH20G','Sau khi bạn chọn trà sữa yêu thích và nhấn nút "Thêm giỏ hàng", các sản phẩm sẽ ngay lập tức xuất hiện trong giỏ hàng phía bên phải màn hình. Bạn có thể nhấp vào giỏ hàng để xem và điều chỉnh các sản phẩm trước khi tiến hành thanh toán.');
...
manager.addDocument('vi','Tôi có thể điền thông tin ghi chú vào đơn hàng của mình không?','URHSH21G');
manager.addDocument('vi','Có phương pháp nào để thêm ghi chú cho đơn hàng trước khi thanh toán không?','URHSH21G');
//Ans
manager.addAnswer('vi','URHSH21G','Thường, bạn có thể thêm ghi chú cho đơn hàng trong quá trình đặt mua. Cung cấp thông tin chi tiết giúp cửa hàng làm đúng theo yêu cầu của bạn');
manager.addAnswer('vi','URHSH21G','Thường thì bạn có thể thêm ghi chú cho đơn hàng trong quá trình đặt mua. Hãy cung cấp thông tin chi tiết để cửa hàng có thể đáp ứng yêu cầu của bạn.');
manager.addAnswer('vi','URHSH21G','Trong quá trình đặt mua, bạn có thể thêm ghi chú cho đơn hàng của mình. Hãy cung cấp thông tin chi tiết để cửa hàng có thể hiểu rõ yêu cầu của bạn.');
manager.addAnswer('vi','URHSH21G','Thường thì bạn có thể gửi ghi chú cho đơn hàng trong quá trình đặt mua. Hãy cung cấp thông tin chi tiết để cửa hàng có thể tuân thủ yêu cầu của bạn.');
manager.addAnswer('vi','URHSH21G','Trong quá trình đặt mua, bạn có thể đính kèm ghi chú cho đơn hàng của mình. Hãy cung cấp thông tin chi tiết để cửa hàng có thể thực hiện đúng theo yêu cầu của bạn.');
manager.addAnswer('vi','URHSH21G','Thường thì bạn có thể yêu cầu thêm ghi chú cho đơn hàng trong quá trình đặt mua. Hãy cung cấp thông tin chi tiết để cửa hàng có thể làm đúng theo yêu cầu của bạn.');
...
//Ans
manager.addAnswer('vi','URHSH22J','Trang web hiện tại chấp nhận thanh toán qua cổng thanh toán trực tuyến VNPay');
manager.addAnswer('vi','URHSH22J','Trang web hiện tại cho phép thanh toán qua cổng thanh toán trực tuyến VNPay.');
manager.addAnswer('vi','URHSH22J','Bạn có thể sử dụng cổng thanh toán trực tuyến VNPay để thanh toán trên trang web này');
manager.addAnswer('vi','URHSH22J','Cổng thanh toán trực tuyến VNPay được chấp nhận để thanh toán trên trang web này.');
manager.addAnswer('vi','URHSH22J','Trang web này hỗ trợ thanh toán qua cổng thanh toán trực tuyến VNPay.');
manager.addAnswer('vi','URHSH22J','Bạn có thể sử dụng VNPay để thanh toán trực tuyến trên trang web này.');
...
//URHSH23D
manager.addDocument('vi','Tôi sẽ nhận được xác nhận đơn hàng sau khi hoàn tất thanh toán không?','URHSH23D');
manager.addDocument('vi','Sau khi tôi hoàn tất thanh toán, liệu tôi có nhận được xác nhận đơn hàng không?','URHSH23D');
manager.addDocument('vi','Nếu tôi đã thanh toán thành công, tôi có được xác nhận đơn hàng không?','URHSH23D');
manager.addDocument('vi','Sau khi tôi thanh toán, liệu tôi sẽ nhận được xác nhận đơn hàng không?','URHSH23D');
manager.addDocument('vi','Tôi đã hoàn tất thanh toán, vậy tôi có nhận được xác nhận đơn hàng không?','URHSH23D');
manager.addDocument('vi','Sau khi tôi thanh toán, liệu tôi sẽ nhận được thông báo xác nhận đơn hàng không?','URHSH23D');
//Ans
manager.addAnswer('vi','URHSH23D','Về thường, sau khi hoàn tất thanh toán, bạn sẽ nhận được email xác nhận đơn hàng với thông tin chi tiết về đơn hàng của bạn');
manager.addAnswer('vi','URHSH23D','Thường thì sau khi hoàn tất thanh toán, bạn sẽ nhận được email xác nhận đơn hàng chứa thông tin chi tiết về đơn hàng của bạn.');
manager.addAnswer('vi','URHSH23D','Thông thường, sau khi hoàn tất thanh toán, hệ thống sẽ tự động gửi cho bạn một email xác nhận đơn hàng chứa thông tin chi tiết về đơn hàng của bạn.');
manager.addAnswer('vi','URHSH23D','Sau khi bạn hoàn tất thanh toán, thông thường bạn sẽ nhận được một email xác nhận đơn hàng có chứa thông tin chi tiết về đơn hàng của bạn.');
manager.addAnswer('vi','URHSH23D','Thường thì sau khi thanh toán thành công, bạn sẽ nhận được một email xác nhận đơn hàng với thông tin chi tiết về đơn hàng của bạn.');
...
//URHSH24D
manager.addDocument('vi','Tôi sẽ nhận được xác nhận đơn hàng sau khi hoàn tất thanh toán không?','URHSH24D');
manager.addDocument('vi','Tôi có thể kiểm tra tình trạng giao hàng của đơn hàng của mình như thế nào?','URHSH24D');
manager.addDocument('vi','Làm sao để xem tình trạng giao hàng của đơn hàng của tôi?','URHSH24D');
manager.addDocument('vi','Có cách nào để biết được tình trạng giao hàng của đơn hàng của tôi không?','URHSH24D');
manager.addDocument('vi','Tôi có thể tra cứu tình trạng giao hàng của đơn hàng của mình như thế nào?','URHSH24D');
manager.addDocument('vi','Làm thế nào để kiểm tra xem đơn hàng của tôi đã được giao hay chưa?','URHSH24D');
//Ans
manager.addAnswer('vi','URHSH24D','Bạn có thể theo dõi tình trạng giao hàng thông qua email xác nhận đơn hàng hoặc trang web cửa hàng. Thường có thông tin cập nhật về việc giao hàng');
manager.addAnswer('vi','URHSH24D','Bạn có thể kiểm tra tình trạng giao hàng bằng cách kiểm tra email xác nhận đơn hàng hoặc truy cập vào trang web của cửa hàng. Thông tin về việc giao hàng thường được cập nhật đều đặn trên hai nền tảng này.');
manager.addAnswer('vi','URHSH24D','Để biết tình trạng giao hàng, bạn có thể xem email xác nhận đơn hàng hoặc truy cập vào trang web của cửa hàng. Thông tin về việc giao hàng sẽ được cập nhật thường xuyên trên hai nền tảng này');
manager.addAnswer('vi','URHSH24D','Cách để bạn biết tình trạng giao hàng là thông qua email xác nhận đơn hàng hoặc trang web của cửa hàng. Thường có thông tin mới nhất về việc giao hàng trên hai nền tảng này.');
manager.addAnswer('vi','URHSH24D','Để xem tình trạng giao hàng, bạn có thể kiểm tra email xác nhận đơn hàng hoặc truy cập vào trang web của cửa hàng. Thông tin cập nhật về việc giao hàng sẽ được cung cấp trên hai nền tảng này.');
manager.addAnswer('vi','URHSH24D','Bạn có thể theo dõi tình trạng giao hàng qua email xác nhận đơn hàng hoặc trang web của cửa hàng. Thông tin về việc giao hàng sẽ được cập nhật đều đặn trên hai nền tảng này.');
...
//Ans
manager.addAnswer('vi','FHSH25FB','Đơn hàng của bạn đang trong trạng thái "Chờ xác nhận", vì vậy việc hủy đơn hàng có thể khó khăn. Hãy xem xét kỹ trước khi đặt hàng.');
manager.addAnswer('vi','FHSH25FB','Trong trường hợp đơn hàng của bạn đang chờ xác nhận, việc hủy đơn hàng có thể gặp khó khăn. Vì vậy, hãy xem xét kỹ trước khi tiến hành đặt hàng.');
manager.addAnswer('vi','FHSH25FB','Khi đơn hàng của bạn đang trong trạng thái "Chờ xác nhận", việc hủy đơn hàng có thể không đơn giản. Hãy xem xét kỹ trước khi quyết định đặt hàng.');
manager.addAnswer('vi','FHSH25FB','Nếu đơn hàng của bạn vẫn đang chờ xác nhận, việc hủy đơn hàng có thể không dễ dàng. Vì vậy, hãy suy nghĩ cẩn thận trước khi đặt mua.');
manager.addAnswer('vi','FHSH25FB','Trong trường hợp đơn hàng của bạn đang trong trạng thái "Chờ xác nhận", việc hủy đơn hàng có thể gặp khó khăn. Vì thế, hãy xem xét kỹ trước khi thực hiện đặt hàng');
...
//FHSH26FB
manager.addDocument('vi','Tôi có thể đặt mua trà sữa hàng ngày thông qua trang web không?','FHSH26FB');
...
manager.addDocument('vi','Có cách nào để đặt mua trà sữa hàng ngày qua trang web không?','FHSH26FB');
manager.addDocument('vi','Tôi có thể đặt mua trà sữa hàng ngày trên trang web được không?','FHSH26FB');
//Ans
manager.addAnswer('vi','FHSH26FB','Đúng vậy! Bạn hoàn toàn có thể đặt mua trà sữa hàng ngày trên trang web của chúng tôi.');
manager.addAnswer('vi','FHSH26FB','Tất nhiên! Trên hệ thống trang web của chúng tôi, bạn có thể đặt mua trà sữa hàng ngày.');
manager.addAnswer('vi','FHSH26FB','Chắc chắn! Hệ thống trang web của chúng tôi cho phép bạn đặt mua trà sữa hàng ngày.');
manager.addAnswer('vi','FHSH26FB','Đương nhiên! Bạn có thể thoải mái đặt mua trà sữa hàng ngày trên trang web của chúng tôi.');
manager.addAnswer('vi','FHSH26FB','Dĩ nhiên! Chúng tôi cung cấp dịch vụ đặt mua trà sữa hàng ngày trên trang web của mình.');
manager.addAnswer('vi','FHSH26FB','Chắc chắn rồi! Bạn có thể đặt mua trà sữa hàng ngày trên hệ thống trang web của chúng tôi ^^');
...
//FHSH27CB
manager.addDocument('vi','Tôi có thể sử dụng thẻ giảm giá khi đặt mua trà sữa trực tuyến không?','FHSH27CB');
manager.addDocument('vi','Tôi có thể áp dụng thẻ giảm giá khi đặt mua trà sữa trực tuyến không?','FHSH27CB');
manager.addDocument('vi','Có chấp nhận thẻ giảm giá khi đặt mua trà sữa trực tuyến không?','FHSH27CB');
manager.addDocument('vi','Thẻ giảm giá có được áp dụng khi đặt mua trà sữa trực tuyến không?','FHSH27CB');
manager.addDocument('vi',"Có thể sử dụng thẻ giảm giá để mua trà sữa trực tuyến không?",'FHSH27CB');
manager.addDocument('vi',"Tôi có thể sử dụng thẻ giảm giá khi đặt mua trà sữa qua mạng không?",'FHSH27CB');
//Ans
manager.addAnswer('vi','FHSH27CB','Đúng vậy! Bạn hoàn toàn có thể đặt mua trà sữa hàng ngày trên trang web của chúng tôi.');
manager.addAnswer('vi','FHSH27CB',"Đúng vậy, khi bạn đặt hàng, bạn có thể nhập mã giảm giá để áp dụng cho đơn hàng của mình. Hãy theo dõi và sử dụng những mã giảm giá tuyệt vời để nhận được ưu đãi đặc biệt cho đơn hàng của bạn nhé.");
manager.addAnswer('vi','FHSH27CB',"Tất nhiên, khi bạn đặt hàng, bạn có thể áp dụng mã giảm giá để giảm giá cho đơn hàng của bạn. Đừng quên kiểm tra và sử dụng những mã giảm giá tuyệt vời để có những ưu đãi tốt nhất cho đơn hàng của bạn.");
manager.addAnswer('vi','FHSH27CB',"Chắc chắn, khi bạn đặt hàng, bạn có thể nhập mã giảm giá để áp dụng cho đơn hàng của mình. Hãy theo dõi và áp dụng những mã giảm giá tuyệt vời để nhận được sự giảm giá đặc biệt cho đơn hàng của bạn.");
manager.addAnswer('vi','FHSH27CB',"Đương nhiên, khi bạn đặt hàng, bạn có thể áp dụng mã giảm giá cho đơn hàng của mình. Hãy chắc chắn rằng bạn theo dõi và sử dụng những mã giảm giá tuyệt vời để nhận được những ưu đãi đặc biệt cho đơn hàng của bạn.");
manager.addAnswer('vi','FHSH27CB',"Dĩ nhiên, khi bạn tiến hành đặt hàng, bạn có thể thêm mã giảm giá vào đơn hàng của bạn. Hãy luôn cập nhật và sử dụng những mã giảm giá tuyệt vời để nhận được những ưu đãi đặc biệt cho đơn hàng của bạn.");
...
//BHSH28DB
manager.addDocument('vi','Tôi cần phải trả phí giao hàng khi đặt mua trà sữa trực tuyến không?','BHSH28DB');
manager.addDocument('vi',"Tôi có phải trả phí vận chuyển khi đặt mua trà sữa trực tuyến không?",'BHSH28DB');
manager.addDocument('vi',"Có mất phí giao hàng khi tôi mua trà sữa trực tuyến không?",'BHSH28DB');
manager.addDocument('vi',"Tôi cần phải trả phí vận chuyển khi đặt mua trà sữa qua mạng không?",'BHSH28DB');
manager.addDocument('vi',"Phải trả phí giao hàng khi mua trà sữa online không?",'BHSH28DB');
manager.addDocument('vi',"Có phải trả phí vận chuyển khi đặt mua trà sữa qua internet không?",'BHSH28DB');
//Ans
manager.addAnswer('vi','BHSH28DB','Có thể. Phí giao hàng phụ thuộc vào cửa hàng và khoảng cách giao hàng. Thông tin về phí giao hàng thường được hiển thị trước khi bạn hoàn tất đơn hàng.');
manager.addAnswer('vi','BHSH28DB',"Có, phụ thuộc vào cửa hàng và khoảng cách giao hàng, thông tin về phí giao hàng sẽ được hiển thị trước khi bạn hoàn tất đơn hàng.");
manager.addAnswer('vi','BHSH28DB',"Phí giao hàng sẽ được tính dựa trên cửa hàng và khoảng cách giao hàng. Trước khi hoàn tất đơn hàng, bạn sẽ thấy thông tin chi tiết về phí này.");
manager.addAnswer('vi','BHSH28DB',"Phí giao hàng sẽ khác nhau tùy thuộc vào cửa hàng và khoảng cách giao hàng. Bạn sẽ biết được thông tin về phí này trước khi hoàn tất việc đặt hàng.");
manager.addAnswer('vi','BHSH28DB',"Có, phí giao hàng được tính dựa trên cửa hàng và khoảng cách giao hàng. Trước khi bạn xác nhận đơn hàng, thông tin về phí sẽ được hiển thị rõ ràng.");
manager.addAnswer('vi','BHSH28DB',"Tùy thuộc vào cửa hàng và khoảng cách giao hàng, phí vận chuyển sẽ được tính toán. Bạn sẽ thấy thông tin chi tiết về phí này trước khi hoàn tất việc đặt hàng.");
...
//BHSH29LB
manager.addDocument('vi','Làm cách nào để tôi biết về thời gian mở cửa của cửa hàng trà sữa trực tuyến?','BHSH29LB');
manager.addDocument('vi',"Bạn có thể tìm hiểu về thời gian mở cửa của cửa hàng trà sữa trực tuyến bằng cách xem thông tin trên trang web hoặc ứng dụng của cửa hàng đó.",'BHSH29LB');
manager.addDocument('vi',"Thông tin về thời gian mở cửa của cửa hàng trà sữa trực tuyến thường được hiển thị trên trang chủ hoặc trang liên hệ của cửa hàng.",'BHSH29LB');
manager.addDocument('vi',"Để biết về thời gian mở cửa của cửa hàng trà sữa trực tuyến, bạn có thể kiểm tra trên trang mạng xã hội hoặc gọi điện thoại trực tiếp đến cửa hàng để được tư vấn.",'BHSH29LB');
manager.addDocument('vi',"Thông tin về thời gian mở cửa của cửa hàng trà sữa trực tuyến thường được cập nhật trên trang Facebook hoặc trang web chính thức của cửa hàng.",'BHSH29LB');
manager.addDocument('vi',"Để biết thời gian mở cửa của cửa hàng trà sữa trực tuyến, bạn có thể tham khảo các đánh giá hoặc bình luận từ khách hàng trước đó trên trang web hoặc ứng dụng của cửa hàng.",'BHSH29LB');
//Ans
manager.addAnswer('vi','BHSH29LB',"Thông tin về thời gian mở cửa thường có trên trang web của cửa hàng. Bạn hãy kiểm tra trước khi đặt hàng để chắc chắn rằng bạn mua trong khoảng thời gian cửa hàng mở cửa.");
manager.addAnswer('vi','BHSH29LB',"Thời gian mở cửa thường được hiển thị trên trang web của cửa hàng. Bạn nên kiểm tra trước khi đặt mua để đảm bảo bạn đặt hàng trong khoảng thời gian cửa hàng mở cửa.");
manager.addAnswer('vi','BHSH29LB',"Bạn nên xem trên trang web của cửa hàng để biết thời gian mở cửa. Điều này giúp bạn đảm bảo rằng bạn đặt hàng trong khoảng thời gian cửa hàng hoạt động.");
manager.addAnswer('vi','BHSH29LB',"Thông tin về thời gian mở cửa thường được hiển thị trên trang web của cửa hàng. Hãy kiểm tra trước khi đặt hàng để đảm bảo bạn chọn thời gian phù hợp.");
manager.addAnswer('vi','BHSH29LB',"Trang web của cửa hàng thường cung cấp thông tin về thời gian mở cửa. Bạn nên kiểm tra trước khi đặt hàng để đảm bảo bạn đặt trong khoảng thời gian cửa hàng hoạt động.");
manager.addAnswer('vi','BHSH29LB',"Để biết thời gian mở cửa, bạn có thể xem trên trang web của cửa hàng. Điều này giúp bạn đặt hàng trong khoảng thời gian cửa hàng mở cửa.");
...
//BHSH30SB
manager.addDocument('vi','Tôi có thể thay đổi phương thức thanh toán sau khi đã đặt hàng không?','BHSH30SB');
manager.addDocument('vi',"Sau khi đã đặt hàng, tôi có thể thay đổi phương thức thanh toán được không?",'BHSH30SB');
manager.addDocument('vi',"Có cách nào để tôi thay đổi phương thức thanh toán sau khi đã hoàn tất đơn hàng không?",'BHSH30SB');
manager.addDocument('vi',"Tôi muốn thay đổi phương thức thanh toán sau khi đã đặt hàng, làm thế nào để làm điều này?",'BHSH30SB');
manager.addDocument('vi',"Nếu tôi muốn thay đổi phương thức thanh toán sau khi đã đặt mua, có phải tôi cần liên hệ với cửa hàng không?",'BHSH30SB');
manager.addDocument('vi',"Có cho phép thay đổi phương thức thanh toán sau khi đã đặt hàng không? Nếu có, làm thế nào để thực hiện điều này?",'BHSH30SB');
//Ans
manager.addAnswer('vi','BHSH30SB',"Đương nhiên, bạn có thể lựa chọn giữa 2 phương thức thanh toán sau khi đã đặt hàng: 'Thanh toán khi nhận hàng' hoặc 'Thanh toán qua ví VNPay'.");
manager.addAnswer('vi','BHSH30SB',"Có thể, sau khi đã đặt hàng, bạn có thể thay đổi phương thức thanh toán sang 'Thanh toán khi nhận hàng' hoặc 'Thanh toán qua ví VNPay'");
manager.addAnswer('vi','BHSH30SB',"Vâng, bạn hoàn toàn có thể thay đổi phương thức thanh toán sau khi đã đặt hàng. Bạn có thể chọn 'Thanh toán khi nhận hàng' hoặc 'Thanh toán qua ví VNPay'.");
manager.addAnswer('vi','BHSH30SB',"Được, bạn có thể lựa chọn giữa 'Thanh toán khi nhận hàng' hoặc 'Thanh toán qua ví VNPay' sau khi đã đặt hàng.");
manager.addAnswer('vi','BHSH30SB',"Tất nhiên, bạn có thể thay đổi phương thức thanh toán sau khi đã đặt hàng. Hai phương thức mà bạn có thể chọn là 'Thanh toán khi nhận hàng' hoặc 'Thanh toán qua ví VNPay'.");




//BHSH31HB
manager.addDocument('vi','Tôi có thể đặt hàng trà sữa trong mục thời gian cố định không?','BHSH31HB');
manager.addDocument('vi',"Có giới hạn thời gian để đặt hàng trà sữa không?",'BHSH31HB');
manager.addDocument('vi',"Tôi cần biết liệu có thời gian cụ thể để đặt hàng trà sữa không?",'BHSH31HB');
...
manager.addDocument('vi',"Tôi muốn biết liệu có giới hạn thời gian nào để đặt hàng trà sữa hay không?",'BHSH31HB');
//Ans
manager.addAnswer('vi','BHSH31HB',"Bất cứ khi nào khi bạn đặt hàng và trong thời gian hoạt động của hệ thống thì bạn có thể đặt hàng và nhận hàng");
manager.addAnswer('vi','BHSH31HB',"Bạn có thể đặt hàng và nhận hàng bất cứ khi nào trong thời gian hoạt động của hệ thống.");
manager.addAnswer('vi','BHSH31HB',"Trong khoảng thời gian hoạt động của hệ thống, bạn có thể đặt hàng và nhận hàng mọi lúc.");
manager.addAnswer('vi','BHSH31HB',"Hệ thống cho phép bạn đặt hàng và nhận hàng trong thời gian hoạt động của nó.");
manager.addAnswer('vi','BHSH31HB',"Khi hệ thống hoạt động, bạn có thể đặt hàng và nhận hàng theo ý muốn.");
manager.addAnswer('vi','BHSH31HB',"Bạn có thể tự do đặt hàng và nhận hàng trong thời gian hoạt động của hệ thống.");
