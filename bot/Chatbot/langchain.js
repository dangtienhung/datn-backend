...
manager.addAnswer(
  "vi",
  "AboutShip",
  "Chào bạn , shop có ship cho bạn ở xa nhé"
);
...
manager.addAnswer(
  "vi",
  "greeting",
  "Hi, Shop đã nhận được tin nhắn của bạn rùi !"
);

manager.addAnswer(
  "vi",
  "NeedHelp",
  "Shop lúc nào có mặt nè , bạn cần hỗ trợ gì thế ? "
);
manager.addAnswer(
  "vi",
  "NeedHelp",
  "Shop đang online nè  , bạn có chuyện gì thế "
);
...
axios
  ...
  .then((response) => {
    ...
    response["data"].forEach((value) => {
      ...
      manager.addDocument(
        "vi",
        "Shop cho em xin giá của món ăn " + value.name,
        "AskProduct" + i
      );
      ...
      manager.addDocument(
        "vi",
        "Shop còn " + value.name + " không ạ !",
        "AskProductLeft?" + i
      );
      manager.addDocument(
        "vi",
        "Shop bán " + value.name + " không",
        "AskProductLeft?" + i
      );
      manager.addDocument(
        "vi",
    ...
    manager.addAnswer(
      "vi",
      "Products",
      "Shop hiện tại có mấy món này nè " + AllProduct
    );
    manager.addAnswer(
      "vi",
      "Products",
    ...
    manager.addAnswer(
      "vi",
      "Products",
      "Sơ sơ có mấy cái này nè bạn " + AllProduct
    );
    manager.addAnswer(
      "vi",
      "Products",
      "Shop có mấy món này mới lên nè " + AllProduct
    );
...
axios
  ...
  .then((response) => {
    ...
    manager.addAnswer(
      "vi",
      "isToppingF",
      "Shop có từng này nè :" + listTopping
    );
    manager.addAnswer(
      "vi",
      "isToppingF",
      "Gửi Một số topping mà shop bán nhé :" + listTopping
    );
