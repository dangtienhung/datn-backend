...
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Bạn có thể sử dụng tài khoản đăng nhập của mình để tạo đơn hàng trà sữa.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Điền thông tin đầy đủ, bao gồm số điện thoại và địa chỉ, vào biểu mẫu để tạo đơn hàng trà sữa một cách nhanh chóng.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Sử dụng tính năng đăng nhập để tạo đơn hàng trà sữa một cách thuận tiện.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Điền đầy đủ thông tin cá nhân, bao gồm số điện thoại và địa chỉ, để tạo đơn hàng trà sữa một cách nhanh nhất.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
...
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Điền thông tin cá nhân, bao gồm số điện thoại và địa chỉ, vào biểu mẫu để tạo đơn hàng trà sữa một cách tiện lợi.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Sử dụng chức năng đăng nhập và điền đầy đủ thông tin cá nhân để tạo đơn hàng trà sữa.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Đăng nhập vào tài khoản của bạn và thực hiện việc tạo đơn hàng trà sữa bằng cách điền đầy đủ thông tin cá nhân.'
);
manager.addAnswer(
  'vi',
  'AFFSS11K',
...
manager.addAnswer(
  'vi',
  'AFFSS11K',
  'Điền đầy đủ thông tin cá nhân, bao gồm số điện thoại và địa chỉ, để tạo đơn hàng trà sữa một cách nhanh chóng và thuận tiện nhất.'
);
...
manager.addDocument(
  'vi',
  'Tôi muốn biết về các loại trà sữa phổ biến mà tôi có thể chọn, có thể giúp tôi không?',
  'BFFSS2k'
);
